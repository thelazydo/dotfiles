...
utils.lazy_load_event("nvim-treesitter", { "BufReadPost", "BufNewFile" }, function()
...
--     -- It is highly recommended to ALWAYS ensure these 5 are installed
--     ensure_installed = { "c", "lua", "vim", "vimdoc", "query", "sql" },
--
...
--
--     highlight = {
--         enable = true, -- Actually enables the rich highlighting
--
...
--     },
--
--     -- Enable indentation rules based on Treesitter
--     indent = {
--         enable = true,
--     },
-- })
